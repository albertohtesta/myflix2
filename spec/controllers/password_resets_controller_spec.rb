...
describe PasswordResetsController do
    describe "GET show" do
        it "renders show template if the token is valid" do
            ...
            alice.update_column(:token, '12345')  # this is because we have amn before create action thats overrides the token
            get :show, id: '12345'
            expect(response).to render_template :show
        end
        it "sets @token" do
            alice = Fabricate(:user)
            alice.update_column(:token, '12345')  # this is because we have a before create action thats overrides the token
            get :show, id: '12345'
