...
describe QueueItemsController do
  ...
  describe "POST create" do
    ...
    it "does not add the video to the queue if the video is already on the queue" do
      alice = Fabricate(:user)
      set_current_user(alice)
      monk = Fabricate(:video)
      Fabricate(:queue_item, video: monk, user: alice)
  ...
  describe "POST update_queue" do
    ...
    context "with valid inputs" do
      ...
      it "normalizes the position numbers" do
        ...
        # also could be : expect(queue_item1.reload.position.to eq(2))
    ...
    context "whit queue_items that do not belong to the current user" do
